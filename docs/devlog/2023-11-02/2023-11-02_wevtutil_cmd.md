---
title: "WEVTUTIL Command"
description: WEVTUTIL is a Windows Event Log Utility Command Line Program.
date: 2023-11-02
author: Jimmy Briggs <jimmy.briggs@jimbrig.com>
os: "Windows"
language: "Command Line"
tags: ["#Windows", "#DOS", "#EventLogs", "#SysAdmin", "#CMD", "#TIL"]
---

# `wevtutil` Command Line Tool on Windows

> Windows Events Command Line Utility.

Enables you to retrieve information about event logs and publishers, install and uninstall event manifests,
run queries, and export, archive, and clear logs.

See below for how to use the tool.
